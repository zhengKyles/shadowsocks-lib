...
package com.kyle.shadowsocks.core.database
...
import com.kyle.shadowsocks.plugin.PluginOptions
import com.kyle.shadowsocks.core.preference.DataStore
import com.kyle.shadowsocks.core.utils.Key
import com.kyle.shadowsocks.core.utils.asIterable
import com.kyle.shadowsocks.core.utils.parsePort
...
data class Profile(
        ...
        var id: Long = 0,
        var name: String? = "",
        var host: String = "lighthouse_guangzhou1.haigui.mobi",
        var remotePort: Int = 6200,
        var password: String = "uYhVA160ZoSg3AI5",
        var method: String = "rc4-md5",
